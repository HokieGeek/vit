...
if exists("g:vit_log_use_new_colors")
    highlight VitLogTime    ctermbg=none     ctermfg=148      cterm=none
    highlight VitLogAuthor  ctermbg=none     ctermfg=61       cterm=none
    highlight VitLogBranch  ctermbg=none     ctermfg=130      cterm=none
else
